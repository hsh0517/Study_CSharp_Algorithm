...
namespace Algorithm
{
    ...
    public class Player
    {
        ...
        private void AStar()
        {
            // 8방향
            // U L D R UL DL DR UR
            int[] deltaY = new int[] { -1, 0, 1, 0/*, -1, 1, 1, -1*/ }; // 대각선 이동 시 주석 해제
            int[] deltaX = new int[] { 0, -1, 0, 1/*, -1, -1, 1, 1*/ }; // 대각선 이동 시 주석 해제
            int[] cost = new int[] { 10, 10, 10, 10/*, 14, 14, 14, 14*/ }; // 대각선 이동 시 주석 해제
